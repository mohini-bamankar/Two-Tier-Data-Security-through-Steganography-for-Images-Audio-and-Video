...
import two_tier_security_steaganography.OperationFrame;
 ...
 JButton open = new JButton("Open"), embed = new JButton("Embed"), send = new JButton("Send"),
    save = new JButton("Save"), reset = new JButton("Reset"), back = new JButton("Back");
...
//       getMaximumWindowBounds());
 ...
 private void openOperationFrame()
 {
     this.dispose();
